export const MAILING_HOST = process.env.MAILGUN_SMTP_SERVER || 'smtp.mailgun.org';
export const MAILING_PORT = process.env.MAILGUN_SMTP_PORT || 587;
export const MAILING_USERNAME = process.env.MAILGUN_SMTP_LOGIN || '';
export const MAILING_PASSWORD = process.env.MAILGUN_SMTP_PASSWORD || '';
...
export const MAILING_TEST_MODE = JSON.parse(process.env.MAILING_TEST_MODE || "false" );
